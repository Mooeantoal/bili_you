...
class Comment {
  ...
  factory Comment.fromJson(Map<String, dynamic> json) {
    ...
    return Comment(
      ...
      replies: replies,
      isUp: json['member']['level_info'] != null && 
            json['member']['level_info']['current_level'] != null &&
            json['member']['level_info']['current_level'] >= 6,
      level: json['member']['level_info'] != null 
          ? (json['member']['level_info']['current_level'] ?? 0) 
          : 0,
      isVip: json['member']['vip'] != null && 
             json['member']['vip']['vipStatus'] == 1,
    );
  }
...
class _PiliPlusCommentsPageState extends State<PiliPlusCommentsPage> {
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                              color: comment.isVip ? Colors.red : null,
                            ),
                          ),
                          // UP主标识
                          if (comment.isUp) ...[
                          ...
                          const SizedBox(width: 4),
                          Image.asset(
                            'assets/images/lv/lv${comment.level}.png',
                            height: 10,
                          ),
                        ],
                      ),
  ...
  void _showReplyDetail(Comment reply, Comment rootComment) async {
    // 获取完整的楼中楼评论列表
    String rootId = rootComment.rpid.toString();
